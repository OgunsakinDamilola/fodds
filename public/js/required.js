        ...
        buttons: {
            ...
            danger: {
                ...
                callback: function() {
                    $.niftyNoty({
                        type: 'danger',
                        message : '<strong>Oh snap!!!</strong> Please ensure to meet up with our requirements before starting any application',
                        container : 'floating',
                        timer : 5000
                    });
